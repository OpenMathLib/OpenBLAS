...
typedef enum CBLAS_ORDER     {CblasRowMajor=101, CblasColMajor=102, uNDEF=-1} CBLAS_ORDER;
typedef enum CBLAS_TRANSPOSE {CblasNoTrans=111, CblasTrans=112, CblasConjTrans=113, CblasConjNoTrans=114, UNDEFINED=-1} CBLAS_TRANSPOSE;
typedef enum CBLAS_UPLO      {CblasUpper=121, CblasLower=122, UNDEF=-1} CBLAS_UPLO;
