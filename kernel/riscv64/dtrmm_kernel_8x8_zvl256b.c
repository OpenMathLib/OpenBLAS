...

{
    ...
    for (BLASLONG j=0; j<N/8; j+=1) {
        ...
        for (BLASLONG i=0; i<M/8; i+=1) {
            ...
            vfloat64m1_t c0 = vfmul_vf_f64m1_ta( result0, alpha, gvl );
            vfloat64m1_t c1 = vfmul_vf_f64m1_ta( result1, alpha, gvl );
            vfloat64m1_t c2 = vfmul_vf_f64m1_ta( result2, alpha, gvl );
            vfloat64m1_t c3 = vfmul_vf_f64m1_ta( result3, alpha, gvl );
            vfloat64m1_t c4 = vfmul_vf_f64m1_ta( result4, alpha, gvl );
            vfloat64m1_t c5 = vfmul_vf_f64m1_ta( result5, alpha, gvl );
            vfloat64m1_t c6 = vfmul_vf_f64m1_ta( result6, alpha, gvl );
            vfloat64m1_t c7 = vfmul_vf_f64m1_ta( result7, alpha, gvl );
            vfloat64m1_t c8 = vfmul_vf_f64m1_ta( result8, alpha, gvl );
            vfloat64m1_t c9 = vfmul_vf_f64m1_ta( result9, alpha, gvl );
            vfloat64m1_t c10 = vfmul_vf_f64m1_ta( result10, alpha, gvl );
            vfloat64m1_t c11 = vfmul_vf_f64m1_ta( result11, alpha, gvl );
            vfloat64m1_t c12 = vfmul_vf_f64m1_ta( result12, alpha, gvl );
            vfloat64m1_t c13 = vfmul_vf_f64m1_ta( result13, alpha, gvl );
            vfloat64m1_t c14 = vfmul_vf_f64m1_ta( result14, alpha, gvl );
            vfloat64m1_t c15 = vfmul_vf_f64m1_ta( result15, alpha, gvl );
