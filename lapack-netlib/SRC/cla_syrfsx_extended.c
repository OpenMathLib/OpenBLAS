...
/*  ===================================================================== */
/* Subroutine */ int cla_syrfsx_extended_(integer *prec_type__, char *uplo, 
	...
	integer *info)
{
    ...
    extern /* Subroutine */ int blas_csymv_x_(integer *, integer *, complex *
	    , complex *, integer *, complex *, integer *, complex *, complex *
	    , integer *, integer *);
    integer uplo2, i__, j;
    extern logical lsame_(char *, char *);
    extern /* Subroutine */ int blas_csymv2_x_(integer *, integer *, complex 
    ...
    extern /* Subroutine */ int caxpy_(integer *, complex *, complex *, 
	    integer *, complex *, integer *);
    logical upper;
    extern /* Subroutine */ int cla_syamv_(integer *, integer *, real *, 
