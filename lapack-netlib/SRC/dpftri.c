...
/* > */
/*  ===================================================================== */
/* Subroutine */ void dpftri_(char *transr, char *uplo, integer *n, doublereal 
	*a, integer *info)
{
    ...
    logical nisodd;
    extern /* Subroutine */ void dlauum_(char *, integer *, doublereal *, 
	    integer *, integer *);
    extern void dtftri_(char *, char *, char *, 
