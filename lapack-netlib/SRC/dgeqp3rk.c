...
/* Subroutine */ void dgeqp3rk_(integer *m, integer *n, integer *nrhs, integer 
	...
	integer *iwork, integer *info)
{
    ...
    /* Local variables */
    extern /* Subroutine */ void dlaqp2rk_(integer *, integer *, integer *, 
...
/*            the input parameters M, N, NRHS, KMAX, LDA are valid. */
    ...
    if (*info != 0) {
	i__1 = -(*info);
	xerbla_("DGEQP3RK", &i__1, (ftnlen)8);
	return;
    } else if (lquery) {
	return;
    }
