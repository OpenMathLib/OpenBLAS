...
/* > */
/*  ===================================================================== */
/* Subroutine */ void dlamtsqr_(char *side, char *trans, integer *m, integer *
	...
	doublereal *work, integer *lwork, integer *info)
{
    ...
    integer ctr;
    extern /* Subroutine */ void dgemqrt_(char *, char *, integer *, integer *,
	     integer *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, doublereal *, integer *), dtpmqrt_(char *, char *, integer *, integer *, 
