...
/* > \verbatim */
/* > */
/* >    DLANTR = ( f2cmax(abs(A(i,j))), NORM = 'M' or 'm' */
/* >             ( */
...
/* Computing MIN */
		    i__3 = *m, i__4 = j - 1;
		    i__2 = f2cmin(i__3,i__4);
		    dlassq_(&i__2, &a[j * a_dim1 + 1], &c__1, colssq, &colssq[
			    1]);
...
/* Computing MIN */
		    i__3 = *m, i__4 = j + 1;
		    dlassq_(&i__2, &a[f2cmin(i__3,i__4) + j * a_dim1], &c__1, 
			    colssq, &colssq[1]);
		    dcombssq_(ssq, colssq);
/* L310: */
		}
		...
		for (j = 1; j <= i__1; ++j) {
		    ...
		    colssq[1] = 1.;
		    i__2 = *m - j + 1;
		    dlassq_(&i__2, &a[j + j * a_dim1], &c__1, colssq, &colssq[
			    1]);
		    dcombssq_(ssq, colssq);
/* L320: */
		}
