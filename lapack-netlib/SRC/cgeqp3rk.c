...
/* Subroutine */ void cgeqp3rk_(integer *m, integer *n, integer *nrhs, integer 
	...
	info)
{
    ...
    /* Local variables */
    extern /* Subroutine */ void claqp3rk_(integer *, integer *, integer *, 
    ...
    real eps;
    integer iws, ioffset;
    extern /* Subroutine */ void claqp2rk_(integer *, integer *, integer *, 
	    integer *, integer *, real *, real *, integer *, real *, complex *
...
/*            the input parameters M, N, NRHS, KMAX, LDA are valid. */
    ...
    if (*info != 0) {
	i__1 = -(*info);
	xerbla_("CGEQP3RK", &i__1, (ftnlen)8);
	return;
    } else if (lquery) {
	return;
    }
