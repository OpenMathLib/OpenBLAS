...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sporfsx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sporfsx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sporfsx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	info)
{
    ...
    real rthresh;
    extern real sla_porcond_(char *, integer *, real *, integer *, real *, 
	    integer *, integer *, real *, integer *, real *, integer *);
    real cwise_wrong__;
...
/*     Perform refinement on each right-hand side */
	...
	sla_porfsx_extended_(&prec_type__, uplo, n, nrhs, &a[a_offset], lda, 
...
/*     Compute scaled normwise condition number cond(A*C). */
	...
	if (rcequ) {
	    rcond_tmp__ = sla_porcond_(uplo, n, &a[a_offset], lda, &af[
