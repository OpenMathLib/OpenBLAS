...
/*  ===================================================================== */
/* Subroutine */ int cla_gerfsx_extended_(integer *prec_type__, integer *
	...
	integer *info)
{
    ...
    extern /* Subroutine */ int cla_lin_berr_(integer *, integer *, integer *
	    , complex *, real *, real *);
    real ymin;
    extern /* Subroutine */ int blas_cgemv_x_(integer *, integer *, integer *
	    , complex *, complex *, integer *, complex *, integer *, complex *
	    , complex *, integer *, integer *);
    real dxratmax, dzratmax;
    integer y_prec_state__, i__, j;
    extern /* Subroutine */ int blas_cgemv2_x_(integer *, integer *, integer 
