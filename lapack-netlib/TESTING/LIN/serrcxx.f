...
*> \verbatim
*>
*> SERRCXX tests the error exits for SERRCXX that does
*> CX decomposition.
*> \endverbatim
*
*  Arguments:
...
*
      DO J = 1, NMAX
         ...
         DO I = 1, NMAX
            ...
            QRC( I, J ) = 1.E+0 / REAL( I+J )
            X( I, J ) = 1.E+0 / REAL( I+J )
         END DO
      END DO
*
*     Create a NaN
...
*     ======================
     ...
     $             X, 1, W, 1, IW, 1, INFO )
      CALL CHKXER( 'SGECXX', INFOT, NOUT, LERR, OK )
*
*     ======================
