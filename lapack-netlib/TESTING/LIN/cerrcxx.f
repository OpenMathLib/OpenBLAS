...
*> \verbatim
*>
*> CERRCXX tests the error exits for CERRCXX that does
*> CX decomposition.
*> \endverbatim
*
*  Arguments:
...
*     .. Local Scalars ..
      INTEGER            I, INFO, J, K
      REAL               MAXC2NRMK, RELMAXC2NRMK, FNRMK,
     $                   NAN, ONE, ZERO
*     ..
*     .. Local Arrays ..
...
*
      DO J = 1, NMAX
         ...
         IW( J ) = -J
         DO I = 1, NMAX
            A( I, J ) = 1.E+0 / CMPLX( I+J )
            C( I, J ) = 1.E+0 / CMPLX( I+J )
            QRC( I, J ) = 1.E+0 / CMPLX( I+J )
            X( I, J ) = 1.E+0 / CMPLX( I+J )
         END DO
      END DO
*
*     Create a NaN
...
*     ======================
     ...
     $             X, 1, W, 1, RW, 1, IW, 1, INFO )
      CALL CHKXER( 'CGECXX', INFOT, NOUT, LERR, OK )
*
*     ======================
