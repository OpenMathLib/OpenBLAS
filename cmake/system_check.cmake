...
# Check if user provided ARCH override
if (DEFINED ARCH AND NOT "${ARCH}" STREQUAL "")
  message(STATUS "Using user-specified ARCH: ${ARCH}")
  # Set architecture flags based on user-provided ARCH
  ...
  elseif ("${ARCH}" STREQUAL "arm")
    set(ARM 1)
  elseif ("${ARCH}" STREQUAL "power")
    set(POWER 1)
  elseif ("${ARCH}" STREQUAL "mips")
    set(MIPS32 1)
  elseif ("${ARCH}" STREQUAL "mips64")
    set(MIPS64 1)
  elseif ("${ARCH}" STREQUAL "zarch")
    set(ZARCH 1)
  ...
  elseif ("${ARCH}" STREQUAL "riscv64")
    ...
    message(WARNING "Unknown ARCH value: ${ARCH}")
  endif ()
# Pretty thorough determination of arch. Add more if needed
elseif(CMAKE_CL_64 OR MINGW64)
...
# Set ARCH based on detected architecture flags (only if not already set by user)
